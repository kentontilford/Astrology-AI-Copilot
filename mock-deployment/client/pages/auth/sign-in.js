      ...
      <div style={{
        ...
        <form>
          ...
          <div style={{ 
            ...
            <a href="#" style={{ color: '#6D28D9', textDecoration: 'none', fontSize: '0.875rem' }}>
              Forgot password?
            </a>
          </div>
          ...
          <div style={{ textAlign: 'center', marginTop: '1.5rem' }}>
            <p style={{ color: '#6B7280' }}>
              Don't have an account? <a href="/auth/sign-up" style={{ color: '#6D28D9', textDecoration: 'none' }}>Sign up</a>
            </p>
          </div>
        </form>
      </div>
